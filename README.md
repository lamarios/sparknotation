...
[![maven](https://maven-badges.herokuapp.com/maven-central/com.ftpix/sparknotation/badge.svg)](https://mvnrepository.com/artifact/com.ftpix/sparknotation)
...
```
dependencies {
    compile group: "com.ftpix", name: "sparknotation", version:"1.15"
}
```
